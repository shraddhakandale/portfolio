...
import { MY_IMG_URL } from "../utility/constants";

const MainContainer = () => {
  return (
    <div className="flex flex-col p-40 gap-4 justify-center items-center">
        <img className="w-40 h-40 rounded-full object-contain" src={MY_IMG_URL} alt="My photo"/>
